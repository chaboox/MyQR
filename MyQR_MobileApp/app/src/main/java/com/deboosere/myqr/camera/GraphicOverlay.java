...
public class GraphicOverlay<T extends GraphicOverlay.Graphic> extends View {
    ...
    public void add(T graphic) {
        synchronized (mLock) {
         ...
         /*   for (BarcodeGraphic graphic0 : BarcodeCaptureActivity.mGraphicOverlay.getGraphics()) {
                Barcode barcode = graphic0.getBarcode();
                if((!MainActivity.barcode2.contains(barcode)) && (barcode != null))
                MainActivity.barcode2.add(barcode);
              //  Log.d("VAL", "add: "+(MainActivity.barcode2.contains(barcode)  && (barcode != null)));
               // Log.d("yop", "barcode "+barcode.displayValue);
            }*/
        }
        postInvalidate();
    }
